...
my $Arch2Qemu = {
    ...
    alpha => '/usr/bin/qemu-system-alpha', 
    arm => '/usr/bin/qemu-system-arm', 
    avr => '/usr/bin/qemu-system-avr', 
    cris => '/usr/bin/qemu-system-cris', 
    hppa => '/usr/bin/qemu-system-hppa', 
    i386 => '/usr/bin/qemu-system-i386', 
    m68k => '/usr/bin/qemu-system-m68k', 
    microblaze => '/usr/bin/qemu-system-microblaze', 
    microblazeel => '/usr/bin/qemu-system-microblazeel', 
    mips => '/usr/bin/qemu-system-mips', 
    mips64 => '/usr/bin/qemu-system-mips64', 
    mips64el => '/usr/bin/qemu-system-mips64el', 
    mipsel => '/usr/bin/qemu-system-mipsel', 
    nios2 => '/usr/bin/qemu-system-nios2', 
    or1k => '/usr/bin/qemu-system-or1k', 
    ppc => '/usr/bin/qemu-system-ppc', 
    ppc64 => '/usr/bin/qemu-system-ppc64', 
    riscv32 => '/usr/bin/qemu-system-riscv32', 
    riscv64 => '/usr/bin/qemu-system-riscv64', 
    rx => '/usr/bin/qemu-system-rx', 
    s390x => '/usr/bin/qemu-system-s390x', 
    sh4 => '/usr/bin/qemu-system-sh4', 
    sh4eb => '/usr/bin/qemu-system-sh4eb', 
    sparc => '/usr/bin/qemu-system-sparc', 
    sparc64 => '/usr/bin/qemu-system-sparc64', 
    tricore => '/usr/bin/qemu-system-tricore', 
    xtensa => '/usr/bin/qemu-system-xtensa', 
    xtensaeb => '/usr/bin/qemu-system-xtensaeb', 
